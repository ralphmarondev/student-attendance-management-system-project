...
{
    public partial class GuestViewReportsForm : Form
    {
        private string class_code;

        public GuestViewReportsForm()
        {
            InitializeComponent();
        }

        public GuestViewReportsForm(string class_code)
        {
            InitializeComponent();
        ...
        private void GuestViewReportsForm_Load(object sender, EventArgs e)
        {
            cb_class_code.Text = class_code;
