...
{
    public partial class SetupFormAddStudents : Form
    {
        public SetupFormAddStudents()
        {
            InitializeComponent();
        }

        // constructor for passing data
        public SetupFormAddStudents(string college, string department, string semester, string school_year, string class_enrolled)
        {
            InitializeComponent();
